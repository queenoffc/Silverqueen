...
# =============================================================================
# PTERODACTYL PANEL COMPLETE PROTECTION SCRIPT
# All-in-One Protection: Anti Delete, Anti Access, Anti Modify
# Modified: Allow ID 1 and ID 2
# =============================================================================

PROTECT_NAME="PAPA•QUEEN亗"
TIMESTAMP=$(date -u +"%Y-%m-%d-%H-%M-%S")

echo "========================================"
echo "🛡️  PTERODACTYL PROTECTION INSTALLER"
echo "    Protected by ©${PROTECT_NAME}"
echo "========================================"
echo ""

# =============================================================================
# 1. SERVER DELETION SERVICE
# =============================================================================
echo "📦 [1/9] Installing Server Deletion Protection..."
    ...
    public function handle(Server $server): void
    {
        ...
        if ($user) {
            if (!in_array($user->id, [1, 2])) {
                ...
                if ($ownerId !== $user->id) {
                    throw new DisplayException('❌ Ngapain sih bang? Protected by ©PROTECT_NAME_PLACEHOLDER');
                }
            }
        }
...
sed -i "s/PROTECT_NAME_PLACEHOLDER/${PROTECT_NAME}/g" "$REMOTE_PATH"
...
# 2. USER CONTROLLER
# =============================================================================
echo "📦 [2/9] Installing User Controller Protection..."
...
class UserController extends Controller
{
    ...
    public function delete(Request $request, User $user): RedirectResponse
    {
        if (!in_array($request->user()->id, [1, 2])) {
            throw new DisplayException("❌ Jangan rusuh bang! Protected by ©PROTECT_NAME_PLACEHOLDER");
        }
    ...
    public function update(UserFormRequest $request, User $user): RedirectResponse
    {
        ...
        foreach ($restrictedFields as $field) {
            if ($request->filled($field) && !in_array($request->user()->id, [1, 2])) {
                throw new DisplayException("⚠️ Data hanya bisa diubah oleh admin ID 1 atau ID 2.");
            }
        }

        if ($user->root_admin && !in_array($request->user()->id, [1, 2])) {
            throw new DisplayException("🚫 Tidak dapat menurunkan hak admin pengguna ini. Hanya ID 1 dan ID 2 yang memiliki izin.");
        }
...
# =============================================================================
echo "📦 [3/9] Installing Location Controller Protection..."
...
class LocationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        if (!$user || !in_array($user->id, [1, 2])) {
            abort(403, 'Akses ditolak! Protected by ©PROTECT_NAME_PLACEHOLDER');
        }
    ...
    public function view(int $id): View
    {
        $user = Auth::user();
        if (!$user || !in_array($user->id, [1, 2])) {
            abort(403, '❌ Ngapain sih bang? Protected by ©PROTECT_NAME_PLACEHOLDER');
        }
...
# 4. NEST CONTROLLER
# =============================================================================
echo "📦 [4/9] Installing Nest Controller Protection..."
...
# 5. FILE CONTROLLER
# =============================================================================
echo "📦 [5/9] Installing File Controller Protection..."
...
class FileController extends ClientApiController
{
    ...
    {
        $this->checkServerAccess($request, $server);
        $token = $this->jwtService->setExpiresAt(CarbonImmutable::now()->addMinutes(15))->setUser($request->user())->setClaims(['file_path' => rawurldecode($request->get('file')), 'server_uuid' => $server->uuid])->handle($server->node, $request->user()->id . $server->uuid);
...
# 6. NODE CONTROLLER
# =============================================================================
echo "📦 [6/9] Installing Node Controller Protection..."
...
# =============================================================================
echo "📦 [7/9] Installing Settings Controller Protection..."
...
# 8. SERVER CONTROLLER
# =============================================================================
echo "📦 [8/9] Installing Server Controller Protection..."
...
# =============================================================================
# 9. DETAILS MODIFICATION SERVICE
# =============================================================================
echo "📦 [9/9] Installing Details Modification Protection..."
...
echo "   [1] Server Deletion Protection"
echo "   [2] User Controller Protection"
echo "   [3] Location Controller Protection"
echo "   [4] Nest Controller Protection"
echo "   [5] File Controller Protection"
echo "   [6] Node Controller Protection"
echo "   [7] Settings Controller Protection"
echo "   [8] Server Controller Protection"
echo "   [9] Details Modification Protection"
echo ""
echo "🔒 Protected by: ©${PROTECT_NAME}"
echo "🗂️  Backup timestamp: ${TIMESTAMP}"
echo ""
echo "⚠️  IMPORTANT:"
echo "   - User ID 1 dan ID 2 memiliki akses penuh"
echo "   - Regular users hanya bisa manage server milik sendiri"
echo "   - Semua file di-backup otomatis"
echo ""
